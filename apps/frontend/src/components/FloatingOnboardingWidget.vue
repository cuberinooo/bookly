...
<template>
  <transition name="slide-up">
    <div
      v-if="showWidget"
      class="floating-onboarding-container"
      ...
      >
        ...
        <div class="panel-header p-3 flex items-center justify-between bg-primary-50 border-b border-primary-100">
          <div class="flex items-center gap-2">
            <i class="pi pi-compass text-primary font-bold" />
            <h3 class="m-0 text-sm font-black text-primary-800 uppercase tracking-widest">
              {{ t('onboarding.trainingGuide') }}
            </h3>
          </div>
          <Button
            icon="pi pi-minus"
                  ...
                  <div class="flex items-center justify-between mb-1">
                    <div class="flex items-center gap-2">
                      ...
                      <span
                        ...
                        class="bg-green-100 text-green-700 text-[8px] px-1 rounded font-black uppercase"
                      >{{ t('onboarding.activeHere') }}</span>
                    </div>
                    <span
                      v-if="task.isDone"
