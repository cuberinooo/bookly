...
<template>
  <div class="max-w-4xl mx-auto py-12 px-4">
    <div class="mb-10">
        <h1 class="text-4xl font-extrabold tracking-tight">Athlete Profile</h1>
        <p class="text-slate-600 mt-2 font-medium">Manage your personal information and preferences</p>
    </div>
            ...
            <div class="phoenix-card">
                <form @submit.prevent="updateProfile" class="flex flex-col gap-6">
                    ...
                    <div class="flex flex-col">
                        ...
                        <InputText v-model="user.email" type="email" disabled class="opacity-70 cursor-not-allowed" />
                        <small class="text-slate-400 mt-1">Email cannot be changed</small>
                    </div>

                    <div class="pt-4">
                        <Button severity="primary" type="submit" label="Save Changes" :loading="loading" class="btn-primary" />
                    </div>
                </form>
            </div>
        </div>
